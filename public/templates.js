...
<form-group :dataset="pathDataset" input-id="pathInput" input-name="path" input-label="*Path:" placeholder="john-smith" help-id="pathHelp" help="Unique, no spaces or underscores."></form-group>
